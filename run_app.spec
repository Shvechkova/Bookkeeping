...
# Собираем статику Django админки
import os
import django
from django.conf import settings

# Настраиваем Django для сбора статики
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'project.settings')
django.setup()

# Получаем путь к статике Django
django_static_path = os.path.dirname(django.__file__)
admin_static_path = os.path.join(django_static_path, 'contrib', 'admin', 'static', 'admin')
